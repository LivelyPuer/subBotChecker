...
Бот использует SQLite3 с тремя основными таблицами:
...
- id: Автоинкремент ID
- channel_id: ID канала
- message_text: Текст поста
- success_text: Текст при успешной проверке
- fail_text: Текст при неудачной проверке (новое)
- button_text: Текст кнопки
- photo_file_id: ID файла изображения
- message_id: ID сообщения в канале
- created_by: Создатель поста
- created_at: Дата создания
```
...
**Версия:** 2.2.0 (с Markdown форматированием и всплывающими уведомлениями)  
**Лицензия:** MIT
